        ...
        <div className="w-full bgagin flex flex-col items-center justify-center
          ...
          <div className="w-full text-right border-b-2 border-neutral-300">
            ...
            <QuestionItem 
              ...
              answer="نحن نسعى جاهدين لضمان أن الجزء الأكبر من التبرعات يذهب مباشرة إلى الأهداف الخيرية. نسبة صغيرة تذهب لتغطية تكاليف الإدارة والتشغيل، وهذا يتيح لنا تقديم المزيد من الدعم للمحتاجين"/>
