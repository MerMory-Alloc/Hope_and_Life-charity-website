        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-8">
            <div className="flex flex-col items-center justify-center gap-2">
                <div className="w-[140px] h-[130px] relative">
                    <div className="w-[110px] h-[130px] bg-gray-100 rounded-[50%] ml-px"></div>
                    <Image src={smile} width={140} className="absolute rotate-12 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"/>
                </div>
            ...
            <div className="flex flex-col items-center justify-center gap-2">
                <div className="w-[200px] h-[130px] relative">
                    <div className="relative left-8 w-[60px] h-[110px] bg-gray-100 rounded-[50%] inline-block -rotate-[30deg] "></div>
                    <div className="relative bottom-1 w-[70px] h-[130px] bg-gray-100 rounded-[50%] inline-block "></div>
                    <div className="relative right-7 w-[50px] h-[120px] bg-gray-100 rounded-[50%] inline-block rotate-[30deg] "></div>
                    <Image src={sun} width={130} className="absolute -rotate-12 -top-4"/>
                </div>
